...
_G.packer_plugins = {
  ...
  ["cmp-dictionary"] = {
    after_files = { "/Users/katsuyatorii/.local/share/nvim/site/pack/packer/opt/cmp-dictionary/after/plugin/cmp_dictionary.vim" },
  ...
  firenvim = {
    loaded = true,
    path = "/Users/katsuyatorii/.local/share/nvim/site/pack/packer/start/firenvim",
  ...
  ["vim-startuptime"] = {
    ...
    needs_bufread = false,
    only_cond = false,
    path = "/Users/katsuyatorii/.local/share/nvim/site/pack/packer/opt/vim-startuptime",
    url = "https://github.com/dstein64/vim-startuptime"
  },
  ["vim-surround"] = {
    after = { "vim-repeat" },
    keys = { { "", "<Plug>Dsurround" }, { "", "<Plug>CSurround" }, { "", "<Plug>Ysurround" }, { "", "<Plug>YSurround" }, { "", "<Plug>Yssurround" }, { "", "<Plug>VSurround" }, { "", "<Plug>VgSurround" }, { "", "<Plug>Isurround" }, { "", "<Plug>ISurround" } },
    loaded = false,
    needs_bufread = false,
    only_cond = false,
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'vim-better-whitespace', 'nvim-lspconfig', 'lspsaga.nvim', 'vim-context-commentstring', 'nvim-ts-rainbow2', 'nvim-colorizer.lua', 'bufferline.nvim', 'nvim-scrollbar', 'hlargs.nvim', 'nvim-ts-autotag'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-dictionary', 'cmp-emoji', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'nvim-autopairs', 'copilot-cmp', 'cmp_luasnip', 'cmp-buffer'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
