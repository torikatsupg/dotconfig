...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-surround', 'copilot-cmp', 'cmp_luasnip', 'cmp-buffer', 'cmp-path', 'nvim-autopairs', 'cmp-dictionary', 'cmp-emoji', 'cmp-nvim-lsp'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'hlargs.nvim', 'lspsaga.nvim', 'nvim-ts-rainbow', 'nvim-colorizer.lua', 'nvim-ts-autotag', 'nvim-scrollbar', 'nvim-lspconfig'}, { event = "BufRead *" }, _G.packer_plugins)]]
