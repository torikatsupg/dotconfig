...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'bufferline.nvim', 'indent-blankline.nvim', 'lspsaga.nvim', 'nvim-ts-rainbow', 'nvim-lspconfig', 'vim-better-whitespace', 'nvim-colorizer.lua', 'nvim-scrollbar', 'nvim-ts-autotag', 'hlargs.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp-path', 'cmp-dictionary', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'nvim-autopairs', 'copilot-cmp', 'cmp-emoji', 'cmp_luasnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
