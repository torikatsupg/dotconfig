...
_G.packer_plugins = {
  ...
  ["nvim-lspconfig"] = {
    after = { "mason.nvim", "mason-lspconfig.nvim", "formatter.nvim" },
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspsaga.nvim', 'nvim-lspconfig', 'vim-better-whitespace', 'indent-blankline.nvim', 'nvim-colorizer.lua', 'vim-context-commentstring', 'bufferline.nvim', 'nvim-scrollbar', 'hlargs.nvim', 'nvim-ts-rainbow2', 'nvim-ts-autotag'}, { event = "BufRead *" }, _G.packer_plugins)]]
vim.cmd [[au CmdlineEnter * ++once lua require("packer.load")({'cmp-cmdline-history', 'cmp-buffer', 'cmp-cmdline', 'cmp-path'}, { event = "CmdlineEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'nvim-treesitter', 'noice.nvim', 'nightfox.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-dictionary', 'cmp-emoji', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'nvim-autopairs', 'copilot-cmp', 'cmp_luasnip', 'cmp-buffer', 'cmp-path'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
