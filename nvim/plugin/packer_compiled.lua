...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp_luasnip', 'copilot-cmp', 'cmp-buffer', 'cmp-path', 'cmp-dictionary', 'cmp-emoji', 'cmp-nvim-lsp', 'cmp-nvim-lsp-signature-help', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'bufferline.nvim', 'nvim-colorizer.lua', 'hlargs.nvim', 'nvim-scrollbar', 'indent-blankline.nvim', 'nvim-ts-autotag', 'lspsaga.nvim', 'nvim-lspconfig', 'nvim-ts-rainbow', 'vim-better-whitespace'}, { event = "BufRead *" }, _G.packer_plugins)]]
