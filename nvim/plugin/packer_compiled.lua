...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-scrollbar', 'nvim-ts-autotag', 'bufferline.nvim', 'nvim-ts-rainbow', 'nvim-colorizer.lua', 'indent-blankline.nvim', 'lspsaga.nvim', 'nvim-lspconfig', 'hlargs.nvim', 'vim-better-whitespace'}, { event = "BufRead *" }, _G.packer_plugins)]]
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'copilot-cmp', 'cmp-buffer', 'cmp-dictionary', 'cmp-path', 'nvim-autopairs', 'cmp-emoji', 'cmp-nvim-lsp', 'cmp_luasnip', 'cmp-nvim-lsp-signature-help'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
