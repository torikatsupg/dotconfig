...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-buffer', 'cmp_luasnip', 'cmp-emoji', 'cmp-path', 'cmp-dictionary', 'cmp-nvim-lsp', 'copilot-cmp', 'nvim-autopairs'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'nvim-ts-rainbow', 'nvim-lspconfig', 'bufferline.nvim', 'nvim-ts-autotag', 'hlargs.nvim', 'vim-better-whitespace', 'lspsaga.nvim', 'nvim-scrollbar', 'nvim-colorizer.lua'}, { event = "BufRead *" }, _G.packer_plugins)]]
